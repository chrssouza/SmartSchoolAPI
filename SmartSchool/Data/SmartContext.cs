    ...
    public class SmartContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<AlunoDisciplina>()
                .HasKey(AD => new {AD.AlunoId, AD.DisciplinaId}); // referenciando muitos pra muitos

            builder.Entity<AlunoCurso>()
                .HasKey(AD => new {AD.AlunoId, AD.CursoId}); // referenciando muitos pra muitos

            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira"),
                    new Professor(2, 2, "Roberto", "Santos"),
        ...
        //{
        //    optionsBuilder.UseSqlServer(@"Server = (DESKTOP-9UQ40QF)\mssqllocaldb; Database = SmartSchollAPI");
        //}
